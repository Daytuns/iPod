...
import { useNowPlaying2 } from "./useNowPlaying2";
...
function IPod() {
  ...
  const { currentlyPlaying, isPlaying, togglePlayback, playNext, playPrevious, device, seekPosition, fetchCurrentlyPlaying } = useNowPlaying2();
