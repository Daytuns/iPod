          ...
          {songs.map((item, i) => (
            ...
            >
              ...
              <div className="flex flex-col gap-0.5">
                <span className="font-semibold truncate text-[10px]">{item.track.name}</span>
                <span className="text-[9px] text-gray-300 truncate">{item.track.artists.map(a => a.name).join(", ")}</span>
              </div>
            </li>
          ))}
        </ul>
